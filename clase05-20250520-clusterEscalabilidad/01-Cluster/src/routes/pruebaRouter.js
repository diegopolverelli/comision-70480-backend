...
router.get('/op1',(req,res)=>{
    ...
    console.log(valor1, valor2, resultado, `procesado por pid: ${process.pid} - worker: ${cluster.worker.id}`)
...
router.get('/op2',(req,res)=>{
    ...
    console.log(contador, resultado, `procesado por pid: ${process.pid} - worker: ${cluster.worker.id}`)
    console.timeEnd("Demora operación:")
